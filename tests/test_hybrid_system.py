...
from conceptual_synthesis.hybrid_system import (
    triangle_logic_core,
    square_state_preservation,
    hexagon_combinatory_synthesis,
...
class TestHybridSystem(unittest.TestCase):
    ...
    def test_triangle_logic_core(self):
        self.assertTrue(triangle_logic_core([True, True, True]))
        self.assertFalse(triangle_logic_core([True, False, True]))
        self.assertFalse(triangle_logic_core([]))
    ...
    def test_square_state_preservation(self):
        ...
        npt.assert_array_almost_equal(square_state_preservation(state, update), expected)

    def test_hexagon_combinatory_synthesis(self):
        streams = [np.array([1.0, 2.0]), np.array([3.0, 4.0]), np.array([5.0, 6.0])]
        result = hexagon_combinatory_synthesis(streams)
